            ...
            <CardContent className="pt-6">
              <Alert className="mb-4 border-yellow-300 bg-yellow-50">
                ...
                <AlertDescription className="text-yellow-800">
                  <strong>前提条件：</strong>
                  需要安装MetaMask钱包，并连接到Sepolia测试网络，账户中需要有测试ETH用于支付Gas费用。
                </AlertDescription>
              </Alert>
              ...
              <div className="space-y-4">
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
                    <h4 className="font-semibold text-blue-900 mb-2">1. 连接钱包</h4>
                    <ul className="text-sm text-blue-800 space-y-1">
                      <li>• 安装MetaMask浏览器插件</li>
                      <li>• 切换到Sepolia测试网络</li>
                      <li>• 获取测试ETH（通过水龙头）</li>
                      <li>• 在管理员页面连接钱包</li>
                    </ul>
                  </div>
                  <div className="bg-green-50 p-4 rounded-lg border border-green-200">
                    <h4 className="font-semibold text-green-900 mb-2">2. 审核申请</h4>
            ...
            <CardContent className="pt-6">
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">
                    A: 可以在Sepolia Etherscan (sepolia.etherscan.io) 上查看交易记录和合约状态。
                  </p>
                </div>
              </div>
            </CardContent>
